## USACO results processing and upload into DL (dl.gsu.by) [![Build Status](https://travis-ci.org/zshamrock/usaco-results-upload.svg?branch=master)](https://travis-ci.org/zshamrock/usaco-results-upload)
